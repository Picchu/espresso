...
class Calc(Base):
    ...
    def __init__(self, name=None, state='New', extra=None, code=None):
        self.name = name
        self.state = state
        self.extra = extra
        self.code = code
...
class Data(Base):
    ...
    def __init__(self, name=None, state=None, validity='new',
        content=None, hash=None, extra=None):
        self.name = name
        self.state = state
...
class Code(Base):
    ...
    def __init__(self, name=None, path=None, content=None, hash=None, extra=None):
        self.name = name
        self.path = path
        self.content = content
        self.hash = hash
...
class Computer(Base):
    ...
    def __init__(self, name=None, content=None, extra=None):
        self.name = name
        self.content = content
        self.extra = extra
...
class Recall(Control):
    ...
    """
    def __repr__(self):
        return "<Call {0} -> {1}>".format(self.caller, self.helper)
...
class Call(Control):
    ...
    """
    def __repr__(self):
        return "<Summon {0} -> {1}>".format(self.caller, self.helper)
...
class Suspend(Control):
    ...
    """
    def __repr__(self):
        return "<Suspend {0} -> {1}>".format(self.caller, self.helper)
